...
public class Profesional {
    ...
    public Profesional(int id, String usuario, int telefono, String email, String fotodePerfil, String titulodeProfesional, int calificacion, String curriculum, String localidad, String provincia, String contrasena, String nombre, String apellido) {
        this.id = id;
        this.usuario = usuario;
        this.telefono = telefono;
        this.email = email;
